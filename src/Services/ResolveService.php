...
use Bila\ServiceContracts\ResolveContract;
 ...
 */
final class ResolveService implements ResolveContract
{
    /**
     * @api
     */
    public ResolveRawService $raw;
    ...
    {
        $this->raw = new ResolveRawService($client);
    }
    ...
    public function bankAccount(
        ...
        $response = $this->raw->bankAccount(params: $params, requestOptions: $requestOptions);
    ...
    public function mobileMoney(
        ...
        $params = Util::removeNulls(
            ['country' => $country, 'operator' => $operator, 'phone' => $phone]
        );

        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->mobileMoney(params: $params, requestOptions: $requestOptions);
