...
use Bila\Transactions\TransactionListResponse\Data;

/**
 * @phpstan-import-type DataShape from \Bila\Transactions\TransactionListResponse\Data
 *
...
final class TransactionListResponse implements BaseModel
{
     ...
     * ```
     * TransactionListResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransactionListResponse)->withMessage(...)->withStatus(...)
     * ```
     */
