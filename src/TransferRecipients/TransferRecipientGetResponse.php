 ...
 *
 * @phpstan-type TransferRecipientGetResponseShape = array{
 *   message: string,
 *   status: bool,
 *   data?: null|RecipientResponseDto|RecipientResponseDtoShape,
 * }
 */
final class TransferRecipientGetResponse implements BaseModel
{
    /** @use SdkModel<TransferRecipientGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new TransferRecipientGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransferRecipientGetResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransferRecipientGetResponse)->withMessage(...)->withStatus(...)
     * ```
     */
