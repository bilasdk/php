...
use Bila\Accounts\AccountListResponse\Data;
...
/**
 * @phpstan-import-type DataShape from \Bila\Accounts\AccountListResponse\Data
 *
...
final class AccountListResponse implements BaseModel
{
     ...
     * ```
     * AccountListResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AccountListResponse)->withMessage(...)->withStatus(...)
     * ```
     */
