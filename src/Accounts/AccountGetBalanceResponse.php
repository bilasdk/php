...
use Bila\Accounts\AccountGetBalanceResponse\Data;
...
/**
 * @phpstan-import-type DataShape from \Bila\Accounts\AccountGetBalanceResponse\Data
 *
...
final class AccountGetBalanceResponse implements BaseModel
{
    ...
    /**
     * `new AccountGetBalanceResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AccountGetBalanceResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AccountGetBalanceResponse)->withMessage(...)->withStatus(...)
     * ```
     */
