 ...
 *
 * @phpstan-type TransferInitiateMobileMoneyTransferResponseShape = array{
 *   message: string,
 *   status: bool,
 *   data?: null|TransferResponseDto|TransferResponseDtoShape,
 * }
 */
final class TransferInitiateMobileMoneyTransferResponse implements BaseModel
{
    /** @use SdkModel<TransferInitiateMobileMoneyTransferResponseShape> */
    use SdkModel;
    ...
    /**
     * `new TransferInitiateMobileMoneyTransferResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransferInitiateMobileMoneyTransferResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransferInitiateMobileMoneyTransferResponse)
     *   ->withMessage(...)
     *   ->withStatus(...)
     * ```
     */
