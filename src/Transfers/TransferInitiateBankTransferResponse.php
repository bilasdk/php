 ...
 *
 * @phpstan-type TransferInitiateBankTransferResponseShape = array{
 *   message: string,
 *   status: bool,
 *   data?: null|TransferResponseDto|TransferResponseDtoShape,
 * }
 */
final class TransferInitiateBankTransferResponse implements BaseModel
{
    /** @use SdkModel<TransferInitiateBankTransferResponseShape> */
    use SdkModel;
    ...
    /**
     * `new TransferInitiateBankTransferResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransferInitiateBankTransferResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransferInitiateBankTransferResponse)->withMessage(...)->withStatus(...)
     * ```
     */
