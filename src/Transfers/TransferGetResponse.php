 ...
 *
 * @phpstan-type TransferGetResponseShape = array{
 *   message: string,
 *   status: bool,
 *   data?: null|TransferResponseDto|TransferResponseDtoShape,
 * }
 */
final class TransferGetResponse implements BaseModel
{
    /** @use SdkModel<TransferGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new TransferGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransferGetResponse::with(message: ..., status: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransferGetResponse)->withMessage(...)->withStatus(...)
     * ```
     */
